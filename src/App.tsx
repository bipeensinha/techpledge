...
import DevOpsConsultingRole from './Components/Training/Bootcamp';
...
import Bootcamp from './Components/Training/Bootcamp';
      ...
      <Router>
        ...
        <section>
          <Switch>
            ...
            <Route path="/Bootcamp" exact component={Bootcamp} />
