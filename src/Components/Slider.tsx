...
class Slider extends React.Component<MyProps> {
    ...
    render() {
        const images = [
            ...
            { url: "../assets/images/5a.jpg" },
        ];
        return (
            <div className="carousel-wrapper">
                <Carousel infiniteLoop useKeyboardArrows autoPlay showThumbs={false} >

                    <div style={{ margin: "0 auto", marginTop: "0 auto",  height: "100%", width: "100%" }}>
                        <img src="../assets/images/2.jpg" alt="Best Online React and React Native  Training" />
                    </div>
                    <div style={{ margin: "0 auto", marginTop: "0 auto", height: "100%", width: "100%"}}>
                        <img src="../assets/images/3.jpg" alt="Best Online DevOps Training"/>
                    </div>
                    <div style={{ margin: "0 auto", marginTop: "0 auto", height: "100%", width: "100%" }}>
                        <img src="../assets/images/4.jpg" alt="Best Online Azure Training"/>
                    </div>
                    <div style={{ margin: "0 auto", marginTop: "0 auto", height: "100%", width: "100%" }}>
                        <img src="../assets/images/5a.jpg" alt="aws certified solutions architect associate training"/>
                    </div>
                    {/* useGPURender: true,
                        showNavs: true,
                        showBullets: true,
