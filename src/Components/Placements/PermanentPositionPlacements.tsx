...
function PermanentPositionPlacements() {
    return (
        <div>
            <Helmet>
        		<title>Live Projects in Azure AWS DevOps</title>
      		</Helmet>
					...
					<div className="container py-md-5">
						<div className="cwp4-two row">
							...
							<div className="cwp4-image col-lg-6 pl-lg-5 mt-lg-0 mt-5">
								<img src="assets/images/x1.png" className="img-fluid" alt="Online Training" />
                                <br />
                                <br />
                        ...
                        <div className="fea-gd-vv row ">	
                            <div className="float-lt feature-gd col-lg-10 col-sm-6">	
                                <div className="icon-info"> <br /><br />
                                    <img src="./assets/images/offerplc.png" alt="Azure Administrator Job" height="450px"  width="120%" />
                                </div>					 
                            </div>	
                        </div>  
                    </div>
