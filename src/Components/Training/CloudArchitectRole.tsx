...
import CardsTranningaws from '../CardsTranningaws';
import CardsTranninggcp from '../CardsTranninggcp';
...
function AzureCloudArchitectRole() {
    return (
        ...
        <div>
           <Helmet>
        		<title>Best AWS Solution Architect Certification Training</title>
      		</Helmet>
...
TechPledge  Offers Various  levels of Solution Architect Training with Hands-On Live Projects and Certifications for different roles in cloud environments
                          ...
                          <div className="cwp4-image col-lg-6 pl-lg-5 mt-lg-0 mt-5">
                              <img src="assets/images/topics/CloudArchitect.jpg" className="img-fluid" alt="Vmware VCP" />
          ...
          <div className="features py-4">
                  ...
                  <h4>Cloud Architect Role</h4>
                      <div className="fea-gd-vv row ">	
                        <div className="float-lt feature-gd col-lg-4 col-sm-12">	
                          <div className="icon-info">
                              <CardsTranning1 title={`Azure Cloud Architect`} certificate={`Azure Cloud Architect`} examcode={`AZ-301/303`} tranhrs={`36 Hr`} exmpre={`6 Hr`} price={`$588`} pdfURL={`assets/images/Cloud Architect/AZ-300.pdf`} />
                          </div>
                        ...
                        <div className="float-lt feature-gd col-lg-4 col-sm-12">	
                          <div className="icon-info">
                            <CardsTranning3 title={`AWS Cloud Architect`} certificate={`AWS Cloud Architect`} examcode={`SAP-C01`} tranhrs={`36 Hr`} exmpre={`6 Hr`} price={`628`} pdfURL={`assets/images/Cloud Architect/AWS-SolArch.pdf`} />
                          </div>
                          <div className="divEnrollnow" >
                            <button type="button" className="btn buttonEnrollNow">Enroll Now</button>
                          </div>						 
                        ...
                        <div className="float-lt feature-gd col-lg-4 col-sm-12">	
                          <div className="icon-info">
                              <CardsTranning2 title={`Azure Database Architect`} certificate={`Azure Database Architect`} examcode={`MS 70-473`} tranhrs={`36 Hr`} exmpre={`6 Hr`} price={`705`} pdfURL={`assets/images/Cloud Architect/Azure-SQL.pdf`} />
                          </div>
                          <div className="divEnrollnow" >
                            <button type="button" className="btn buttonEnrollNow">Enroll Now</button>
                          </div>						 
                      ...
                      <div className="fea-gd-vv row ">	
                        <div className="float-lt feature-gd col-lg-4 col-sm-12">	
                          <div className="icon-info">
                              <CardsTranningaws title={`AWS Cloud Security Architect`} certificate={`AWS Cloud Security Architect`} examcode={`SCS-C01`} tranhrs={`36 Hr`} exmpre={`6 Hr`} price={`705`} pdfURL={`assets/images/Cloud Architect/AWS-Security.pdf`} />
                          </div>		
                          <div className="divEnrollnow" >
                            <button type="button" className="btn buttonEnrollNow">Enroll Now</button>
                          </div>				 
                        ...
                        <div className="float-lt feature-gd col-lg-4 col-sm-12">	
                          <div className="icon-info">
                              <CardsTranninggcp title={`GCP Cloud  Architect`} certificate={`GCP Cloud Architect`} examcode={`GCP-101`} tranhrs={`36 Hr`} exmpre={`6 Hr`} price={`705`} pdfURL={`assets/images/Cloud Architect/AWS-Security.pdf`} />
                          </div>		
                          <div className="divEnrollnow" >
                            <button type="button" className="btn buttonEnrollNow">Enroll Now</button>
                          </div>				 
