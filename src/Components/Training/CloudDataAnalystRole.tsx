...
function CloudDataAnalystRole() {
    return (
        <div>
          <Helmet>
        		<title>Best Big Data Certification Training</title>
      		</Helmet>
          ...
          <section className="w3l-content-with-photo-4">
            ...
            TechPledge  Offers Various  levels of Data Analyst Training with Hands-On a Live Projects and Certifications for different roles in cloud environments.
                          ...
                          <div className="cwp4-image col-lg-6 pl-lg-5 mt-lg-0 mt-5">
                              <img src="assets/images/topics/DataAnalystRole.jpg" className="img-fluid" alt="Jenkins Master" />
                              <br/><br/>

                          </div>
                          <div> <div className="elfsight-app-7fb13449-216e-4a04-aae6-f5b8dfb08ad7"></div></div>
          ...
          <div className="features py-4">
                  ...
                  <h4>Cloud Data Analyst Role</h4>
                      <div className="fea-gd-vv row ">	
                        <div className="float-lt feature-gd col-lg-4 col-sm-12">	
                          <div className="icon-info">
                              <CardsTranning3 title={`AWS Big Data Analyst`} certificate={`AWS Big Data Analyst`} examcode={`BDS-C00`} tranhrs={`36 Hr`} exmpre={`6 Hr`} price={`628`} pdfURL={`assets/images/Data Analyst Role/AWSBigData.pdf`} />
                          </div>
                        ...
                        <div className="float-lt feature-gd col-lg-4 col-sm-12">	
                          <div className="icon-info">
                              <CardsTranning2 title={`Data Science - Python`} certificate={`Data Science Analyst- Python`} examcode={`TP-DS-01`} tranhrs={`36 Hr`} exmpre={`6 Hr`} price={`628`} pdfURL={`assets/images/Data Analyst Role/DataSc-Phy.pdf`} />
                          </div>	
                          <div className="divEnrollnow" >
                            <button type="button" className="btn buttonEnrollNow">Enroll Now</button>
                          </div>					 
                        ...
                        <div className="float-lt feature-gd col-lg-4 col-sm-12">	
                          <div className="icon-info">
                              <CardsTranning4 title={`Data Science - R`} certificate={`Data Science Analyst- R`} examcode={`TP-DS-02`} tranhrs={`36 Hr`} exmpre={`6 Hr`} price={`628`} pdfURL={`assets/images/Data Analyst Role/Datascience-R.pdf`} />
                          </div>	
                          <div className="divEnrollnow" >
                            <button type="button" className="btn buttonEnrollNow">Enroll Now</button>
                          </div>					 
                      ...
                      <div className="fea-gd-vv row ">	
                        <div className="float-lt feature-gd col-lg-4 col-sm-12">	
                          <div className="icon-info">
                              <CardsTranning1 title={`Azure Database Architect`} certificate={`Azure Database Architect`} examcode={`examcode`} tranhrs={`MS 70-473`} exmpre={`6 Hr`} price={`605`} pdfURL={`assets/images/Data Analyst Role/Azure-SQL.pdf`} />
                          </div>	
                          <div className="divEnrollnow" >
                            <button type="button" className="btn buttonEnrollNow">Enroll Now</button>
                          </div>					 
