                      ...
                      <div className="fea-gd-vv row ">	
                        <div className="float-lt feature-gd col-lg-4 col-sm-12">	
                          <div className="icon-info">
                              <Card1 image={'image'} title={`test`} certificate={`certificate`} examcode={`examcode`} tranhrs={`tranhrs`} exmpre={`exmpre`} price={`price`} pdfURL={`pdfURL`} />
                          </div>					 
                        </div>	
                        <div className="float-lt feature-gd col-lg-4 col-sm-12">	
                          <div className="icon-info">
                              <Cards image={'image'} title={`test`} certificate={`certificate`} examcode={`examcode`} tranhrs={`tranhrs`} exmpre={`exmpre`} price={`price`} pdfURL={`pdfURL`} />
                          </div>					 
                        </div>	
                        <div className="float-lt feature-gd col-lg-4 col-sm-12">	
                          <div className="icon-info">
